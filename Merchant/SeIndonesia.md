...
### ✅To-do :
- [ ] Kepala LAN dari masing-masing kabel butuh di ganti karena terdapat minyak dan satunya lagi korosi
- [ ] Improvement di bagian network karena saat ini local area network langsung tersambung ke modem Indihome ( perlu dibuatkan network terpisah dari network public ) . Saat ini untuk nama wifi memang sudah terpisah tetapi masih dalam 1 jaringan yang sama dengan public wifi.
---
